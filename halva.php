...
<div style="max-width:700px; margin:40px auto; background:#fff; padding:20px; border-radius:12px; box-shadow:0 4px 10px rgba(0,0,0,.1); text-align:center;">
  <h2 style="font-family: \'Rouge Script\', cursive; font-size: 48px; color: #b76e79; margin-bottom: 20px;">Халва натуральная</h2>
  <img src="halva.jpg" alt="Халва натуральная" style="width:100%; max-height:400px; object-fit:contain; margin-bottom:20px;" />
